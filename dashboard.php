...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/jobber/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Oct 2021 12:53:05 GMT -->
...
Banner -->
    <div class="col-12 ">
        <section class="banner bg-overlay-black-30 text-white ">
            <img src="assets/images/banner.png " width="100% " style="position: absolute; " />
            <div class="container ">
                <div class="row ">
                    <div class="col-12 text-center d-inline-flex ">
                        <div class=" offset-sm-4 offset-4 p-1 counter wrapper " style="position: relative; top: 6rem;z-index: 2; ">
                            <div class="col-3 text-center " style="display: grid; "><span class="counter-time col-12 " style="position: relative; top: 35px; ">0</span>
    ...
    <div class="mt-2 m-0 ">
        ...
        <div class="row m-0 mobile-none d-md-block d-xl-block d-xxl-block ">
            <div class="col-12 text-center d-flex ">
                <div class="col-4 mt-4 ">
                    <div class="col-12 ">
                        <strong>With One Cats</strong>
                    </div>
                    <div class="col-12 mt-1 "><strong class="text-brown">- 10% off on X, X, X</strong></div>
                </div>
                <div class="col-4 mt-4 ">
                    <div class="col-12 "><strong>With Two Cats</strong></div>
                    <div class="col-12 mt-1 "><strong class="text-brown">- 20% off on X, X, X</strong></div>
                </div>
                <div class="col-4 mt-4 ">
                    <div class="col-12 "><strong>With Three Cats</strong></div>
                    <div class="col-12 mt-1 "><strong class="text-brown">- 30% off on X, X, X</strong>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row m-0 mt-8 ">
            <div class="col-10 offset-1 d-flex ">
                <div class="col-3 ">
                    <div class="col-12 ">
                        <h1 class="text-brown"> The Silent</h1>
                    </div>
            ...
            <div class="col-md-12 d-md-flex mt-6 ">
                ...
                <div class="col-md-6 col-sm-12 mt-3 ">
                    <div class="col-12 p-4 ">
                        ...
                        <a onclick="myFunction() " id="myBtn" class="text-brown">Read more</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row m-0 text-center mt-6 ">
        ...
        <div class="row m-0 mt-7 ">
            <div class="col-10 offset-1 ">
                <img src="assets/images/roadmap-all.png " alt=" " class="img-fluid ">
            </div>
        </div>
